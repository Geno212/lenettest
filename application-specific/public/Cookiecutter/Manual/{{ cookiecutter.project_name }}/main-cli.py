#!/usr/bin/env python3
"""
CLI Training Script for Manual (Custom) Models
...
def train_with_progress(
    ...
    console.print(Panel.fit(
        "[bold cyan]Starting Manual Model Training[/bold cyan]",
        border_style="cyan"
    ))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train a custom manual model via CLI with progress tracking",
